...
export class ShowEmployeesComponent implements OnInit {
  ...
  public firstPage() {
    this.employees = [];
    this.dbRestApiService.sendGetRequestToUrl(this.dbRestApiService.first)
  ...
  public previousPage() {
    ...
    if (this.dbRestApiService.prev !== undefined && this.dbRestApiService.prev !== '') {
      this.employees = [];
      this.dbRestApiService.sendGetRequestToUrl(this.dbRestApiService.prev)
        .pipe(takeUntil(this.destroy$)).subscribe((res: HttpResponse<any>) => {
          console.log(res);
          this.employees = res.body;
        });
  ...
  public nextPage() {
    if (this.dbRestApiService.next !== undefined && this.dbRestApiService.next !== '') {
      this.employees = [];
      this.dbRestApiService.sendGetRequestToUrl(this.dbRestApiService.next)
        .pipe(takeUntil(this.destroy$)).subscribe((res: HttpResponse<any>) => {
          console.log(res);
          this.employees = res.body;
        });
  ...
  public lastPage() {
    this.employees = [];
    this.dbRestApiService.sendGetRequestToUrl(this.dbRestApiService.last)
      .pipe(takeUntil(this.destroy$)).subscribe((res: HttpResponse<any>) => {
        console.log(res);
        this.employees = res.body;
      });
